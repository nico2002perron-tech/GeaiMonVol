...
/* ═══════════════════════════════════════════════════════
   CARTOON SPACE GLOBE — 3D Interactive Globe
...
// Continent-based colors — one pleasant color per continent
...
const COUNTRY_CONTINENT: Record<string, string> = {
    ...
    'Congo': 'Africa', 'Dem. Rep. Congo': 'Africa', "Côte d'Ivoire": 'Africa',
...
export default function CartoonGlobe({
    ...
    useEffect(() => {
        ...
        const animate = () => {
            ...
            // ─── ATMOSPHERE GLOW (blue halo around globe) ───
            ...
            // ─── COUNTRIES (colored by continent) ───
            for (const country of countries) {
                ...
                // ✨ DEAL COUNTRY GLOW — pulsing aura
                if (hasDeal) {
                    ctx.save();
            ...
            if (yulProjected) {
                ...
                ctx.fillText('✈️', yulProjected[0], yulProjected[1]);
                ctx.restore();
            ...
            // ─── GLOBE HIGHLIGHT (cartoon 3D shine) ───
            ctx.save();
